...
class TasksInProgressTM extends Component {
    ...
    submitBlockTask() {
        this.setBlockTaskModalVisible(false)
        this.props.navigation.navigate('TasksBlockedTM')
    }

    taskComplete() {
        this.props.navigation.navigate('TasksCompletedTM')
    }
        ...
        return (
            <Block style={ styles.blockStyle }>
                ...
                <Block style={ styles.btnBlock }>
                    ...
                    <Button color="white" style={ styles.centering } onPress={() => this.props.navigation.navigate('TasksInProgressTM')}>
...
export default TasksInProgressTM;