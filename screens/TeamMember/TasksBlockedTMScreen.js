...
class TasksBlockedTM extends Component {
        ...
        return (
            <Block style={ styles.blockStyle }>
                ...
                <Block style={ styles.btnBlock }>
                    ...
                    <Button color="white" style={ styles.centering } onPress={() => this.props.navigation.navigate('TasksBlockedTM')}>
