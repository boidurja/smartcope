...
class AddNewProjectSA extends Component {
        ...
        return (
            <Block style={ styles.blockStyle }>
                ...
                <Block style={ styles.btnBox }>
                    <Button round style={ styles.cancelBtn } onPress={() => this.props.navigation.navigate('Projects')}>
                        <Text style={ styles.btnTextColor }>Cancel</Text>
                    </Button>
                    <Button round style={ styles.submitBtn } onPress={() => this.props.navigation.navigate('Projects')}>
...
export default AddNewProjectSA;