...
class TasksInProgressM extends Component {
    ...
    submitBlockTask() {
        this.setBlockTaskModalVisible(false)
        this.props.navigation.navigate('TasksBlockedM')
    }

    taskComplete() {
        this.props.navigation.navigate('TasksCompletedM')
    }
...
export default TasksInProgressM;